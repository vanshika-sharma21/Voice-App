...
class BaseEvent:
    ...
    def handle_event(self, action, data):
        method_name = {
            ...
            "agent-joined": "on_agent_joined",
            "agent-left": "on_agent_left",
            ...
            "agent-state-changed": "on_agent_state_changed",
            "agent-transcript": "on_agent_transcript",
            "agent-metrics": "on_agent_metrics",
        }.get(action, None)
...
class AgentEventHandler(ParticipantEventHandler):
    def on_agent_state_changed(self, data) -> None:
        """
        Handle agent state changed event.
        """

    def on_agent_transcript(self, data) -> None:
        """
        Handle agent transcript event.
        """

    def on_agent_metrics(self, data) -> None:
        """
        Handle agent metrics event.
        """

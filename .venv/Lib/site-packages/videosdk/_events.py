...
class VideoSDKEvents(Enum):
    ...
    EV_AGENT_JOINED = "agent-joined"
    EV_AGENT_LEFT = "agent-left"
    ...
    # Agent
    EV_AGENT_STATE_CHANGED = "agent-state-changed"
    EV_AGENT_TRANSCRIPT = "agent-transcript"
    EV_AGENT_METRICS = "agent-metrics"
